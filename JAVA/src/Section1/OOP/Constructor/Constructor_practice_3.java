...
public class Constructor_practice_3 {
    public static void main(String[] args) {
        ...
        iPhone11 i = new iPhone11("blue", "xs", false); //클래스 내 생성자의 파라미터로 들어감
        iPhone11 j = new iPhone11("red");
        System.out.println("\n***MY iPhone11***");
...
class iPhone11 { //클래스 영역
    ...
    iPhone11(String colour, String model, boolean damaged)  //생성자
    {
        this.colour = colour;      //클래스명인 iPhone11 대신 this를 쓴다
        this.model = model;          //생성자 안의 this.변수명 은 필드의 변수를 가르킨다!
        this.damaged = damaged;
    }

    iPhone11(String colour) {
        this(colour, "X", true);

        // main 에서 iPhone11 j = new iPhone11("red"); 라고 새 인스턴스를 만들었다.
