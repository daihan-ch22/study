...
public class Kiosk_Program {
     ...
     */
    //TODO:
    static int menu_1_cost = 1000; //김밥
    static int menu_2_cost = 1500; //계란김밥
    static int menu_3_cost = 1000; //충무깁밥
    static int menu_4_cost = 2000; //떡볶이
    ...
    static void input_print() {
        ...
        System.out.println("[안내] 김밥나라에 어서오세요!");
        System.out.println("-------------------------");
    }
    ...
    static void cost(int number) {
        ...
        //TODO:
        if (costCount <= 0 || costCount > 99) {
            System.out.printf("[경고] %d 개는 입력하실 수 없습니다.\n", costCount);
            System.out.println("[경고] 다시 입력하세요.");
            cost(number);
        } else {
            output_print(costCount * number);
        }
    }
    ...
    static void output_print(int result) {
        //TODO:
        System.out.printf("[안내] 주문하신 메뉴의 총 금액은 %d원 입니다.", result);
