...
public class without_interface_coffee_prac {
    public static void main(String[] args) {
        ...
        CafeOwner1 cafeowner = new CafeOwner1();
        CafeCustomerA1 customerA = new CafeCustomerA1();
        CafeCustomerB1 customerB = new CafeCustomerB1();
...
class CafeCustomerA1 extends CafeCustomer{ } //CafeCustomer의 필드와 메서드 상속
class CafeCustomerB1 extends CafeCustomer{ } //CafeCustomer의 필드와 메서드 상속

//카페 사장
class CafeOwner1{
    // giveCoffee메서드 오버라이딩으로  A / B 나눔
    // 손님이 추가될 때마다 메서드 오버라이딩을 해야하는 번거로움이 크다.
    void giveCoffee(CafeCustomerA1 cafeCustomerA){    //메인에서 customerA 객체변수를 받아옴
        System.out.println("iced longblack to Customer A");
    }
    void giveCoffee(CafeCustomerB1 cafeCustomerB){    //메인에서 customerB 객체변수를 받아옴
